...
def read_cs_tob1(file_obj, meta,
    ...
    # Hack in here accounting for endianness of TOB1 - don't know if this
    # changed, but dates only work as little endian. This is the opposite of
    # TOB3 (big endian)!!!
    pyformat = ['<L' if fmt == '>L' else fmt for fmt in pyformat]
